...
const C = s("HTMLFormElement"),
  ...
  P = {
    DIGIT: "0123456789",
    ALPHA: v,
    ALPHA_DIGIT: v + v.toUpperCase() + "0123456789"
  };
...
}), Object.defineProperties(_, L), Object.defineProperty(B, "isAxiosError", {
  value: !0
}), _.from = (e, t, n, r, o, s) => {
...
const I = U.toFlatObject(U, {}, null, function (e) {
...
function z(e, t, n) {
  ...
  function u(e, n, o) {
    ...
    if (e && !o && "object" == typeof e) if (U.endsWith(n, "{}")) n = r ? n : n.slice(0, -2), e = JSON.stringify(e);else if (U.isArray(e) && function (e) {
      return U.isArray(e) && !e.some(D);
    }(e) || (U.isFileList(e) || U.endsWith(n, "[]")) && (a = U.toArray(e))) return n = k(n), a.forEach(function (e, r) {
      !U.isUndefined(e) && null !== e && t.append(!0 === i ? q([n], r, s) : null === i ? n : n + "[]", c(e));
    }), !1;
    return !!D(e) || (t.append(q(o, n, s), c(e)), !1);
  }
  const l = [],
    f = Object.assign(I, {
      defaultVisitor: u,
...
function W(e, t, n) {
  ...
  const r = n && n.encode || V,
    o = n && n.serialize;
  let s;
  if (s = o ? o(t, n) : U.isURLSearchParams(t) ? t.toString() : new H(t, n).toString(r), s) {
    const t = e.indexOf("#");
...
const K = class {
  ...
  $ = {
    isBrowser: !0,
    classes: {
      URLSearchParams: "undefined" != typeof URLSearchParams ? URLSearchParams : H,
...
const Z = {
  ...
  transformRequest: [function (e, t) {
    ...
    if (U.isFormData(e)) return r && r ? JSON.stringify(X(e)) : e;
    ...
    if (o) {
      if (n.indexOf("application/x-www-form-urlencoded") > -1) return function (e, t) {
        return z(e, new $.classes.URLSearchParams(), Object.assign({
          visitor: function (e, t, n, r) {
            return $.isNode && U.isBuffer(e) ? (this.append(t, e.toString("base64")), !1) : r.defaultVisitor.apply(this, arguments);
          }
        }, t));
  ...
  transformResponse: [function (e) {
    const t = this.transitional || Z.transitional,
...
U.forEach(["delete", "get", "head"], function (e) {
  ...
  Z.headers[e] = U.merge(Q);
});
const Y = Z,
  ee = U.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
  te = Symbol("internals");
function ne(e) {
  return e && String(e).trim().toLowerCase();
}
function re(e) {
  return !1 === e || null == e ? e : U.isArray(e) ? e.map(re) : String(e);
}
...
const de = $.isStandardBrowserEnv ? function () {
...
const he = {
  ...
  xhr: "undefined" != typeof XMLHttpRequest && function (e) {
    return new Promise(function (t, n) {
      ...
      U.isFormData(r) && ($.isStandardBrowserEnv || $.isStandardBrowserWebWorkerEnv ? o.setContentType(!1) : o.setContentType("multipart/form-data;", !1));
      ...
      if (c.open(e.method.toUpperCase(), W(u, e.params, e.paramsSerializer), !0), c.timeout = e.timeout, "onloadend" in c ? c.onloadend = l : c.onreadystatechange = function () {
        ...
        const t = (e.withCredentials || de(u)) && e.xsrfCookieName && le.read(e.xsrfCookieName);
        t && o.set(e.xsrfHeaderName, t);
      }
      void 0 === r && o.setContentType(null), "setRequestHeader" in c && U.forEach(o.toJSON(), function (e, t) {
        c.setRequestHeader(t, e);
      }), U.isUndefined(e.withCredentials) || (c.withCredentials = !!e.withCredentials), s && "json" !== s && (c.responseType = e.responseType), "function" == typeof e.onDownloadProgress && c.addEventListener("progress", pe(e.onDownloadProgress, !0)), "function" == typeof e.onUploadProgress && c.upload && c.upload.addEventListener("progress", pe(e.onUploadProgress)), (e.cancelToken || e.signal) && (i = t => {
      ...
      f && -1 === $.protocols.indexOf(f) ? n(new _("Unsupported protocol " + f + ":", _.ERR_BAD_REQUEST, e)) : c.send(r || null);
    });
  }
};
U.forEach(he, (e, t) => {
...
const me = e => {
  ...
  if (!r) {
    ...
    throw new Error(U.hasOwnProp(he, n) ? `Adapter '${n}' is not available in the build` : `Unknown adapter '${n}'`);
  }
  if (!U.isFunction(r)) throw new TypeError("adapter is not a function");
  return r;
};
function ye(e) {
  if (e.cancelToken && e.cancelToken.throwIfRequested(), e.signal && e.signal.aborted) throw new ue(null, e);
}
function ge(e) {
  ye(e), e.headers = ie.from(e.headers), e.data = ae.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1);
  return me(e.adapter || Y.adapter)(e).then(function (t) {
    return ye(e), t.data = ae.call(e, e.transformResponse, t), t.headers = ie.from(t.headers), t;
  }, function (t) {
    return ce(t) || (ye(e), t && t.response && (t.response.data = ae.call(e, e.transformResponse, t.response), t.response.headers = ie.from(t.response.headers))), Promise.reject(t);
  });
}
const be = e => e instanceof ie ? e.toJSON() : e;
function Ee(e, t) {
  t = t || {};
  const n = {};
  function r(e, t, n) {
...
we.transitional = function (e, t, n) {
  ...
  return (n, o, s) => {
    ...
    return t && !Oe[o] && (Oe[o] = !0, console.warn(r(o, " has been deprecated since v" + t + " and will be removed in the near future"))), !e || e(n, o, s);
  };
};
const Se = {
...
class Ae {
  ...
  getUri(e) {
    return W(fe((e = Ee(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer);
  }
}
...
class Ce {
  constructor(e) {
    ...
    this.promise.then(e => {
      ...
      n.reason || (n.reason = new ue(e, r, o), t(n.reason));
    });
  }
  throwIfRequested() {
...
const ve = function t(n) {
  const r = new Te(n),
    o = e(Te.prototype.request, r);
  return U.extend(o, Te.prototype, r, {
    allOwnKeys: !0
  }), U.extend(o, r, null, {
    allOwnKeys: !0
  }), o.create = function (e) {
...
ve.Axios = Te, ve.CanceledError = ue, ve.CancelToken = Ne, ve.isCancel = ce, ve.VERSION = "1.4.0", ve.toFormData = z, ve.AxiosError = _, ve.Cancel = ve.CanceledError, ve.all = function (e) {
...
}, ve.mergeConfig = Ee, ve.AxiosHeaders = ie, ve.formToJSON = e => X(U.isHTMLForm(e) ? new FormData(e) : e), ve.HttpStatusCode = xe, ve.default = ve;
const Pe = ve,
  {
    Axios: Fe,
    AxiosError: Ue,
